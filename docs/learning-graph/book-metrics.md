...
|---|---------|-------|--------|-------|
| 1 | Concepts | 307 | Required | Concepts from learning graph |
...
| 5 | Chapter Quizzes | 0 / 23 | Recommended | Chapters with a quiz.md (0 questions total) |
| 6 | Chapter References | 0 / 23 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 307 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 0 | Recommended | Questions in faq.md |
| 9 | Words | 89,359 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 50 | 50 | H4 headers starting with '#### Diagram:' |
| Equations | 0 | 0 | LaTeX expressions (inline and display) |
| Total Words | 89,359 | 72,246 | Words in markdown files |
| Links | 98 | 68 | Hyperlinks in markdown format |
| Equivalent Pages | 370 | 301 | Estimated pages (250 words/page + visuals) |
